  ...
  render() {
    ...
    const listSettings =
      ...
      this.props.circle.styles.appBar.listDisplayTypes
        ...
        : defaultList.lines[this.state.listTypeId];
          ...
          {this.props.circle.lines.map(circle => {
            return (
              <ListItem key={circle.id} xs={cardColumns}>
                <ComponentController
                  circle={circle}
                  settings={defaultList.lines[this.state.listTypeId].settings}
                  type={this.props.listType || null}
                  handleSingleSelection={this.props.handleSingleSelection}
                  selectedCircle={this.props.selectedCircle}
                />
              </ListItem>
            );
          })}
