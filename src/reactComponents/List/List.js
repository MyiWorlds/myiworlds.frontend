...
class List extends React.Component {
  ...
  switchListType = () => {
    ...
    if (
      ...
      this.props.circle.settings.listDisplayTypes
        ? this.props.circle.settings.length - 1
  ...
  render() {
    ...
    const listSettings =
      this.props.circle &&
      this.props.circle.settings &&
      this.props.circle.settings.appBar &&
      this.props.circle.settings.appBar.listDisplayTypes
        ? this.props.circle.settings.listDisplayTypes[this.state.listTypeId]
        ...
        {this.props.hideOptions ? null : (
          <Bar
            flexDirection={
              ...
              this.props.circle.settings &&
              this.props.circle.settings.appBar &&
              this.props.circle.settings.optionsBar
                ? this.props.circle.settings.optionsBar.flexDirection
            ...
            background={
              ...
              this.props.circle.settings.appbar &&
              this.props.circle.settings.optionsBar
                ? this.props.circle.settings.optionsBar.background
            ...
            padding={
              ...
              this.props.circle.settings.appbar &&
              this.props.circle.settings.optionsBar
                ? this.props.circle.settings.optionsBar.padding
                : optionsBar.padding
            }
            dividerBottom={true}
          >
